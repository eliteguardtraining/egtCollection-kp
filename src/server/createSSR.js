...
import { setIdentity, setPromo } from '../universal/ducks/analytics'
import { getLeadById } from './graphql/models/Leads/helpers'
import analytics from './analytics'
import URL from 'url'
import uuid from 'node-uuid'
import promo from '../universal/utils/promo'
...
async function renderApp(req, res, store, assets, renderProps) {
  ...
  const omitJavaScript = req.url.includes('/iframes')
  ...
  // Needed for analytics to identify which promo the events are coming from
  store.dispatch(setPromo(promo.name))

  if (leadId) {
    winston.log('info', 'Found lead cookie', { leadId, promo, version })
