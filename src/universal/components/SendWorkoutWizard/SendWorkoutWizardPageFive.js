...
@reduxForm({ form: 'sendWorkoutWizard', fields, validate, getFormState, destroyOnUnmount: false })
@Radium
            ...
            <Col xs={12}>
              <fieldset style={styles.fieldset}>
                ...
                <RadioButtonGroup name='shipSpeed' defaultSelected='not_light' onChange={radioChange} valueSelected={selectedage}>
                  ...
                  <RadioButton {...age} value={ages.YOUNGER_THAN_13.value} label={ages.YOUNGER_THAN_13.display} style={styles.radioButton} />

                  <RadioButton {...age} value={ages.BETWEEN_14_AND_18.value} label={ages.BETWEEN_14_AND_18.display} style={styles.radioButton} />

                  <RadioButton {...age} value={ages.OLDER_THAN_18.value} label={ages.OLDER_THAN_18.display} style={styles.radioButton} />
