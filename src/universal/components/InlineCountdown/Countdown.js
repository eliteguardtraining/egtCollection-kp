  ...
  render() {
    ...
    return (
      <div style={styles.countdown}>
        ...
        {!abandoned &&
          <span>
            <TimeUnit inCopy={inCopy} small={small} inline unit={'Days'} number={days} underlineColor={underlineColor} />
            <TimeUnit inCopy={inCopy} small={small} inline unit={'Hours'} number={hours} underlineColor={underlineColor} />
            <TimeUnit inCopy={inCopy} small={small} inline unit={'Minutes'} number={minutes} underlineColor={underlineColor} />
            <TimeUnit inCopy={inCopy} small={small} inline unit={'Seconds'} number={seconds} underlineColor={underlineColor} />
          </span>
        }
      </div>
    )
