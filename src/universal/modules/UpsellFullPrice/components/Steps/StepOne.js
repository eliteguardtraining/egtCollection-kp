...
import { headerStack, bodyStack, proxReg, accuBold, accuBlack } from 'universal/styles/fonts'
              ...
              <Grid fluid>
                <Row>
                  ...
                  <Col sm={7}>
                    ...
                    <p style={styles.p}>
                      Drew has broken the EGT system down into specific training programs for every age and skill level, as well as time of year.
                    </p>
                  </Col>
                </Row>
                <Row>
